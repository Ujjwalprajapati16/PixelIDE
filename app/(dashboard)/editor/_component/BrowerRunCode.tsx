        ...
        <div ref={containerRef}>
            {children}
            {
                openBrowser && (
                    ...
                    >
                        <Resizable className='min-h-56 min-w-80 pb-2 shadow-lg overflow-clip rounded-b-sm bg-white'>
                            <div
                                onMouseDown={handleMouseDown}
                                onMouseUp={handleMouseUp}
                                className='bg-primary h-7 flex items-center cursor-grab px-1'>
                                <X className='ml-auto cursor-pointer' onClick={() => setOpenBrowser(false)} />
                            </div>
                            <div className='relative '>
                                ...
                                <RotateCw
                                    size={16}
                                    className={cn(
                                        'absolute top-2 left-2 hover:text-primary curosr-pointer',
                                ...
                                >
                                    <ExternalLink
                                        size={16}
                                        className={cn(
                                            'absolute top-2 right-2 hover:text-primary curosr-pointer')}
                                    />
                                </Link>
                            </div>
